...
const CampSite = ({backgroundImage, title, subtitle, peopleJoined}: CampProps) => {
    return(
        <div className={`h-full w-full min-w-[1100px] ${backgroundImage}
            bg-cover bg-no-repeat lg:rounded-r-5xl 2xl:rounded-5xl rounded-3xl `}>
...
const Camp = () => {
  return (
    <section className="2xl:max-container relative 
        ...
        <div className="hide-scrollbar flex h-[340px] w-full items-start gap-8
        justify-start overflow-x-auto lg:h-[400px] xl:h-[640px]">
            <CampSite
